...
{
    internal class C2_CompteEpargne_ConstructeurHeritee : C2_CompteBancaire_Constructeur
    {
        double tauxEpargne;
        ...
        public C2_CompteEpargne_ConstructeurHeritee(double tauxEpargne, string nom, string prenom) : base(nom, prenom)
        {
